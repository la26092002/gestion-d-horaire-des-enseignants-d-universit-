...
?>
    ...
    <body>
        ...
        //modifier-les infos
        if (isset($modifier)) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      //BENYAKHOU ELHADJ LARBI MONSIEUR SALEM MOHAMMED
            $query = "UPDATE enseignant SET Email_enseignant = '$mail', Nom_enseignant = '$nom',Prenom_enseignant = '$prenom',Motpass_enseignant = '$motpass'  WHERE id_enseignant='$id_enseignant'";
