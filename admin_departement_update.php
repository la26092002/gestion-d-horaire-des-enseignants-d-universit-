                    ...
                    <div class="col-12 col-md-9 col-lg-9 pb-3 p-3 ">
                        ...
                        if (isset($modifier)) {
                            ...
                            if (empty($departement) || empty($domaine)) {
                                ...
                                $q = "UPDATE departement SET Nom_departement ='$departement',id_domaine='$domaine' WHERE id_departement ='$idd'";
                        ...
                        <div class="card">
                            <div class="card-body shadow" style="background-color: #f8f9fa;">
                                ...
                                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                    <?php
                                    $idd = $_GET['id'];
                                    $sss = "SELECT * FROM departement WHERE id_departement='$idd'";
                                    $qqq = mysqli_query($conn, $sss);
                                    $rrr = mysqli_fetch_assoc($qqq);
                                    ?>
                                    <label class="form-label">Departement</label>
                                    <input type="text" placeholder="<?php echo $rrr['Nom_departement']; ?>" class="form-control " id="departement" name="departement">
                                    ...
                                    <a href="admin_departement.php" class="btn btn-primary mt-3" name="annuler">Annuler</a>
                                </form>
