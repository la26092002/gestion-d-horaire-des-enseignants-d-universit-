    ...
    <body>
        ...
        if (isset($ajouterr)) {
            if (empty($filiere) || empty($faculte) || empty($domaine) || empty($departement)) {
                ...
                $q = "INSERT INTO filiere(Nom_filiere,id_departement)VALUES('$filiere','$departement')";
                ...
                <div class="col-12 col-sm-12 col-md-3 col-lg-3 pb-3 p-3 ">
                    ...
                    <div class="col-12 col-md-9 col-lg-9 pb-3 p-3 ">
                        <div class="card" style="background-color: #f8f9fa;">
                            <div class="card-body shadow">
                                ...
                                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                    ...
                                    <input type="text" placeholder="Filiere" class="form-control " id="filiere" name="filiere">
                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                $('#domainee').on('change', function() {
                                    var domaineeIDD = $(this).val();
                                    if (domaineeIDD) {
                                        $.get(
                                            "Admin-test-filiere-domaine_departement.php", {
                                                domaineeIDD: domaineeIDD
                                            },
                                            function(data) {
                                                $('#departementt').html(data);
                                            }
                                        );
                                    } else {
                                        $('#departementt').html('<option>select faculte first</option>')
                                    }
                                });
                            });

                            $(document).ready(function() {
                                $('#departementt').on('change', function() {
                                    var departementt = $(this).val();
                                    if (departementt) {
                                        $.get(
                                            "Admin-test-filiere-departement_Select.php", {
                                                departementt: departementt
                                            },
                                            function(data) {
                                                $('#Select').html(data);
                                            }
                        ...
                        <div class="card mt-3">
                            ...
                            $iddd = $_GET['id'];
                            if (isset($iddd)) {
                                $query = "DELETE FROM filiere WHERE id_filiere='$iddd'";
                            ...
                            <div class="card-body shadow" style="background-color: #f8f9fa;">
                                ...
                                <div>
                                    <label class="form-label"><i class="fas fa-filter"></i> departement</label>
                                    <select name="departementt" id="departementt" class="departementt form-select">
                                        <option value="">select</option>
                                    </select>
                                </div>
