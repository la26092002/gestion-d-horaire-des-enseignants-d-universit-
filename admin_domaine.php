            ...
            <div class="container-fluids">
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 col-lg-9 pb-3 p-3 ">
                        ...
                        //delete
                        if (isset($iddelete)) {
                            $query = "DELETE FROM domaine WHERE id_domaine='$iddelete'";
                        ...
                        if (isset($ajouterr)) {
                            ...
                            if (empty($faculte) || empty($domaine)) {
                                ...
                                $q = "INSERT INTO domaine(Nom_domaine,id_faculte)VALUES('$domaine','$faculte')";
                        ...
                        <div class="card" style="background-color: #f8f9fa;">
                            <div class="card-body shadow">
                                ...
                                <script>
                                    ...
                                    $(document).ready(function() {
                                        $('#facultee').on('change', function() {
                                            var faculteeIDD = $(this).val();
                                            if (faculteeIDD) {
                                                $.get(
                                                    "Admin-test-departement-domainee_Select.php", {
                                                        faculteeIDD: faculteeIDD
                                                    },
                                                    function(data) {
                                                        $('#Select').html(data);
                                                    }
                                                ...
                                                $('#Select').html('<option>select faculte first</option>')
                                            }
                                        });
                                    });
                                </script>
