                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="menu">
                        <ul class="navbar-nav ms-auto px-5 fs-5 ">
                            <li class="nav-item">
                                <a href="Mon_emploi_du_temps_Enseignant.php" style="color: #003d7a;" class="nav-link" data-current="page">Mon emploi du temps</a>
                            </li>
                        </ul>
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="parametresEnseignant.php">paramètres</a></li>
