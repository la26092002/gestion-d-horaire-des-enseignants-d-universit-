            ...
            <div class="container-fluids">
                <div class="row">
                    ...
                    <div class="col-12 col-md-9 col-lg-9 pb-3 p-3  ">
                        ...
                        $ide = $_GET['ide'];
                        if (isset($ide)) {
                            $up = "UPDATE enseignant SET chef_departement=NULL WHERE id_enseignant='$ide'";
                        ...
                        <div class="card" style="background-color: #f8f9fa;">
                            <div class="card-body shadow">
                                <table class="table table-hover mt-1">
                                    ...
                                    <?php
                                    $sql = "SELECT * FROM enseignant,departement WHERE departement.id_departement=enseignant.chef_departement AND enseignant.chef_departement>'0'";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <th><a href="admin_Consulter_Chef_Departement.php?id=<?php echo $row['id_enseignant']; ?>"><i class="fas fa-user-times link-success"></i></a>
                                                <a href="admin_Consulter_Chef_Departement.php?ide=<?php echo $row['id_enseignant']; ?>"><i class="fas fa-eraser link-success"></i></a>
                                            </th>
                                        </tr>
                                        </tr>
                                    <?php
