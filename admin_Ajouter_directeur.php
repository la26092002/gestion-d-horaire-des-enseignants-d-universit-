                ...
                <div class="col-12 col-md-9 col-lg-9 pb-3 p-3 ">
                    ...
                    if (isset($ajouter)) {
                        ...
                        if (empty($nom) || empty($prenom) || empty($email) || empty($faculte) || empty($domaine) || empty($departement)) {
                            ...
                            $query = "INSERT INTO enseignant(Nom_enseignant,Prenom_enseignant,Email_enseignant,id_departement,Motpass_enseignant,verifie,statut,directeur_detude)
                            VALUES('$nom','$prenom','$email','$departement','univ','1','1','1')";
