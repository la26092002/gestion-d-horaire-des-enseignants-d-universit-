...
$idf = $_GET['id'];
    ...
    if (isset($modifier)) {
        ...
        if (empty($Facultér)) {
            ...
            $q = "UPDATE faculte SET Nom_faculte = '$Facultér' WHERE id_faculte='$idf'";
                ...
                <div class="col-12 col-md-9 col-lg-9 pb-3 p-3 ">
                    ...
                    <div class="card" style="background-color: #f8f9fa;">
                        <div class="card-body shadow">
                            ...
                            <?php
                            $id = $_GET['id'];
                            $sql = "SELECT * FROM faculte WHERE id_faculte='$id'";
                            $query = mysqli_query($conn, $sql);
                            $r = mysqli_fetch_assoc($query);
                            ?>
                            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                <label class="form-label">Faculté</label>
                                <input type="text" placeholder="<?php echo $r['Nom_faculte']; ?>" class="form-control " id="Faculte" name="Faculte">
                                <button class="btn btn-success mt-3" name="modifier">Modifier</button>
                                <a href="admin.php" class="btn btn-primary mt-3" name="annuler">Annuler</a>
                            </form>
